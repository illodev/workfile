...
verified:
  at: "2026-09-14T20:39:17.776Z"
  method: manual
  commit: fca9c8e415bdd59aaa7ce57c244fdcd4242f9327
  digest: "sha256:ecbf0d0ce3c9737fadef52f78d540fbb915ffa9ea615146e46083dd142454901"
---
...
- 2026-09-14 20:15Z illodev@local#a112f2f3 via:undeclared/xhigh — Seen in use in this repository on 2026-09-14, from the built CLI: moving T-0258 to review with its CI criterion open printed 'warning: T-0258 moved to review with 1 unchecked acceptance criterion: #3 Every CI runner configuration passes it on the first run after the push. Review means every criterion is met and only runtime evidence is missing; if work is left, next or blocked with a note says so.' and completed — the legitimate case the card describes, said and let through.
- 2026-09-14 20:39Z illodev@local#a112f2f3 — manual verification: Verified against @illodev/workfile@0.13.2 as published on npm, installed from the registry into a scratch consumer on 2026-09-14: moving a card with one of two criteria open to review printed 'warning: T-0003 moved to review with 1 unchecked acceptance criterion: #2 Runtime evidence. Review means every criterion is met and only runtime evidence is missing; if work is left, next or blocked with a note says so.' and answered 'T-0003 → review', exit 0.
