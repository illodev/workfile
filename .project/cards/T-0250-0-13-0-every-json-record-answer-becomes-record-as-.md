...
- 2026-09-11 19:53Z illodev@local#597ecdc9 via:claude-fable-5-1/xhigh — The verified-criteria-changed warning on this card is mine and is wording only: after the close, criterion 5 was rephrased from naming the consuming repository to 'the consuming repository's scripts', because this repository is public and the owner asked that it carry no details of that consumer. What the criterion asks and how it was met are unchanged; the digest moved because the text did.
