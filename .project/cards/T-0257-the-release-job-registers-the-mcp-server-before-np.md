...
verified:
  at: "2026-09-14T20:39:20.984Z"
  method: ci
  commit: fca9c8e415bdd59aaa7ce57c244fdcd4242f9327
  run: "https://github.com/illodev/workfile/actions/runs/34893653839"
  digest: "sha256:5675541b5e37856c39436fe450cdf9a73374520292dec2e9f3809afa3d8dc9bc"
---
...
- [x] The next tagged release runs green end to end, verified on its workflow run
...
- 2026-09-14 20:39Z illodev@local#a112f2f3 — ci verification: The v0.13.2 release run went green end to end with no manual step: the publish job published @illodev/workfile-search-local@0.13.2 and @illodev/workfile@0.13.2, the MCP Registry step found the version served and published io.github.illodev/workfile 0.13.2 (now isLatest), and the release job created the GitHub Release v0.13.2. npm dist-tag latest is 0.13.2.
